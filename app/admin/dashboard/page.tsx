...
export default async function AdminDashboardPage() {
  ...
  const todayQueryDate = today.toISOString().slice(0, 10);
  ...
  return (
    <div className="space-y-5">
      ...
      <DashboardMetricStrip metrics={[
        ...
        { label: "Pending review", value: pendingReview, detail: "Attendance exceptions today", href: `/admin/attendance?location=missing&from=${todayQueryDate}&to=${todayQueryDate}`, attention: pendingReview > 0 }
      ]} />
        ...
        <div className="space-y-5">
          <Card className="space-y-4">
            ...
            <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
              <LinkButton href={`/admin/attendance?location=missing&from=${todayQueryDate}&to=${todayQueryDate}`} variant="secondary">Review attendance</LinkButton>
