...
export default async function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f3f7fc] p-3 sm:p-6 lg:p-8">
      <div className="relative grid w-full max-w-7xl overflow-hidden rounded-2xl border border-white bg-white shadow-[0_28px_90px_rgba(15,35,76,0.16)] lg:min-h-[min(820px,calc(100vh-4rem))] lg:grid-cols-[1.12fr_0.88fr] lg:rounded-[2rem]">
        <section className="relative hidden min-h-0 overflow-hidden bg-white lg:flex lg:flex-col">
          ...
          <div className="relative min-h-0 flex-1 overflow-hidden bg-[radial-gradient(circle_at_18%_12%,rgba(70,137,236,0.14),transparent_28rem),radial-gradient(circle_at_86%_80%,rgba(249,190,38,0.18),transparent_24rem),linear-gradient(180deg,#ffffff_0%,#f7fbff_100%)] p-8 xl:p-10">
            <Image
          ...
          <div className="relative z-10 border-t border-[#d8e6fb] bg-[#102b74] p-9 text-white xl:p-11">
        ...
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#102b74] p-3 sm:min-h-0 sm:p-8 lg:bg-[linear-gradient(150deg,#102b74_0%,#173466_44%,#f7fbff_44%,#ffffff_100%)] lg:p-10 xl:p-14">
          ...
          <Card className="relative z-10 mt-40 w-full max-w-md rounded-2xl border-0 bg-white p-6 shadow-[0_24px_65px_rgba(3,17,43,0.24)] sm:p-8 lg:mt-0 xl:p-10">
