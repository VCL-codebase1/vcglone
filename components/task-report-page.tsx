...
export async function TaskReportPage({ scope, searchParams }: { scope: ReportScope; searchParams?: { period?: string; date?: string; employeeId?: string; departmentId?: string } }) {
  ...
  return <div className="task-report-print space-y-5">
    ...
    <div className="grid gap-5 xl:grid-cols-2">
      ...
      <Card><div><h2 className="font-semibold text-ink">Current task status</h2><p className="text-sm text-muted">See how work is progressing for the selected period and filters.</p></div><TaskStatusDistributionChart data={report.statusData} /></Card>
    </div>
