  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 max-h-[88vh] w-[calc(100vw-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl border border-white/80 bg-white p-5 shadow-[0_24px_80px_rgba(23,32,51,0.16)] ring-1 ring-line outline-none dark:border-line dark:bg-panel dark:shadow-none",
          className
        )}
      >
